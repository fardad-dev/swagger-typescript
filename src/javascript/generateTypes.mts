 ...
 *
 * Only the types the generator kept as used are received here, see
 * `removeUnusedTypes` of the generator, so a component the generated endpoints
 * never reach is not rendered into `types.ts`.
 *
 * @param types - Used types, rendered sorted by name
 * @param config - Configuration object
 * @returns Content of the generated `types.ts` file
 */
